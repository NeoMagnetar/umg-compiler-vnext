...
export const DEMO_A: UMGExportBundleV1 = {
  ...
  data: {
    blocks: [
      { id: "blk-trigger", role: "TRIGGER", title: "User Intent Detected", content: "When user expresses a goal or task", createdAt: now - 7000 },
      { id: "blk-directive", role: "DIRECTIVE", title: "Safety Constraints", content: "Must not produce harmful content", createdAt: now - 6000 },
      { id: "blk-instruction", role: "INSTRUCTION", title: "Step-by-Step Guide", content: "Break task into subtasks, validate each", createdAt: now - 5000 },
      { id: "blk-subject", role: "SUBJECT", title: "Domain: Writing", content: "Focus on creative writing assistance", createdAt: now - 4000 },
      { id: "blk-primary", role: "PRIMARY", title: "Core Logic Engine", content: "Use chain-of-thought reasoning", createdAt: now - 3000 },
      { id: "blk-philosophy", role: "PHILOSOPHY", title: "Helpful & Honest", content: "Prioritize user benefit over engagement", createdAt: now - 2000 },
      { id: "blk-blueprint", role: "BLUEPRINT", title: "Response Schema v1", content: "JSON output with reasoning trace", createdAt: now - 1000 },
    ],
    neoBlocks: [],
    neoStacks: [],
    sleeve: null,
