  ...
  return (
    <div className="small">
      <div style={{ 
        ...
        Compile uses the current Sleeve JSON blocks/stacks. NeoBlock Library is a saved preview/template (does not change runtime unless inserted).
      </div>

      {!runtime ? (
        <p className="small" style={{ opacity: 0.5 }}>No runtime data</p>
      ) : (
        <>
          <div style={{ 
            padding: 12, 
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              <div style={{ 
                ...
                <div style={{ fontSize: 18, fontWeight: 600 }}>{runtime.neoBlocks?.length ?? 0}</div>
              ...
              <div style={{ 
                ...
                <div style={{ fontSize: 18, fontWeight: 600 }}>
                  {Object.keys(runtime.indexes?.stackNameById ?? {}).length}
                </div>
              ...
              <div style={{ 
                ...
                <div style={{ fontSize: 18, fontWeight: 600 }}>
                  {runtime.indexes?.tags?.allTagsSorted?.length ?? 0}
                </div>
              ...
              <div style={{ 
                ...
                <div style={{ fontSize: 18, fontWeight: 600 }}>
                  {runtime.promptSpec?.neoBlockPrompts?.length ?? 0}
                </div>
          ...
          <div style={{ marginBottom: 8 }}>
            <strong>Sleeve:</strong> <span className="mono">{runtime.sleeveId}</span>
          </div>
